...
from BITA.common.dist_utils import main_process
...
class CaptionTask(BaseTask):
    ...
    def _report_metrics(self, eval_result_file, split_name):
        ...
        coco_gt_root = "/data1/users/yangcong/data/RSIC/UCM/annotations"
...
def coco_caption_eval(coco_gt_root, results_file, split):
    ...
    # coco_eval.params['image_id'] = coco_result.getImgIds()a

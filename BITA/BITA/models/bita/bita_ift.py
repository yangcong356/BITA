...
from BITA.models.base_model import all_gather_with_grad, concat_all_gather
from BITA.models.bita.bita import (
    BITABase,
    compute_sim_matrix,
    disabled_train,
)
from BITA.models.bita.bita_outputs import BITAOutput, BITAOutputFeatures


@Registry.register_model("bita_former")
@Registry.register_model("bita_former_feature_extractor")
class BITAIFformer(BITABase):
    """
    BITA first-stage model with IFT and ViT.
    Supported model types:
        - pretrained: pretrained model with vit-g
        - pretrain_vitL: pretrained model with vit-large
    Usage:
        >>> from lavis.models import load_model
        >>> model = load_model("bita", "pretrain")
    """

    PRETRAINED_MODEL_CONFIG_DICT = {
        "pretrain": "configs/models/bita/bita_pretrain.yaml",
        "pretrain_vitL": "configs/models/bita/bita_pretrain_vitL.yaml",
    }
    ...
    def extract_features(self, samples, mode="multimodal"):
        ...
        Args:
            ...
            mode (str): The mode of feature extraction. Can be either "multimodal", "text" or "image".
                ...
                Default: "multimodal".
        Returns:
            BITAOutputFeatures: A BITAOutputFeatures object containing the features.
        """
